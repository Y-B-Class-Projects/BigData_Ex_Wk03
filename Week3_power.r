...
rng <- 817:1007 #the week of 7 Feb. 2021
...
plot(x = net.generation.table.by.day$DateTime, y = net.generation.table.by.day$sum.net.gen, type="l", xlab="Day", ylab="Net generation [in millions]")
